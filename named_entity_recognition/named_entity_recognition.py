...
if __name__ == '__main__':
    ...
    parser.add_argument("--ground-truth-entities", type=str, help="Ground truth entities of Named Entity Recognition", choices=['SpaCy', 'Amazon Comprehend', 'Common'])
    parser.add_argument("--tool", type=str, help="MGM Tool used for Named Entity Recognition output.", choices=['SpaCy', 'Amazon Comprehend'])
